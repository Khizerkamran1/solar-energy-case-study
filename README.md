...
├── Validiere_Technologies_TakeHomeAssignment.ipynb # Main analysis notebook
├── cost-of-energy.csv # Cleaned energy cost dataset
├── installed-solar-pv-capacity.csv # PV capacity data
├── rise-2016-database.csv # RISE policy and barrier indicators
├── README.md # Project overview (this file)
└── figures/ # Exported visualization outputs
